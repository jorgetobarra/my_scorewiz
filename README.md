...
A desktop app to add votes for a Eurovision-like competition and display the results with tense expectation.
Built with React, Electron and MUI.
...
PD: It'd be nice to be migrated to Typescript before doing any more work in it.
